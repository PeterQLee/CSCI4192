...
Overall, it does not appear that the gated recurrent models the other
...
can be found in Figure \ref{fig:func_evals} in the appendix. It can be observed that increasing parametric
complexity only has a marginal effect on each model. Tables
\ref{table:cumabs1} and \ref{table:Dcumabs1} gives a condensed version
of the data in Figure \ref{fig:mg1_scatter} by showing the scores for
the best performing configuration of the model when sorted by
median. It should be clear from those tables that GRU and LSTM do not
...
30 & 0.0148 $\pm$ 0.0026 &0.0168 $\pm$ 0.0010 &0.0158 $\pm$ 0.0006 &0.0195 $\pm$ 0.0040 \\
