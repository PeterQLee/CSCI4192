...
can be found in Figure \ref{fig:func_evals} in the appendix. \comment{It can be observed that increasing parametric
complexity only has a marginal effect on each model.} Figure \ref{fig:mg1_save} condenses this information by selecting the scores for
